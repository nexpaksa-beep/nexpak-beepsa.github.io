 ...
 * AI CUSTOMER ASSISTANT — FIXED ORIGINAL SCRIPT
 * ============================================================
 */
...
(function () {
    ...
    /* =========================================================
       CHAT STATE (Fixes ReferenceError from old code)
    ========================================================= */
    ...
    /* =========================================================
       SAFETY CHECK (Ensures container exists)
    ========================================================= */

    function chatbotSafetyCheck() {
        const container = document.getElementById("nexpak-chatbot");
        if (!container) {
            console.warn("Nexpak Chat: #nexpak-chatbot container not found in HTML.");
            return false;
        }
        return true;
    }
    ...
    function handleQuickAction(action) {
        if (action === "quote") {
            addUserMessage("I'd like to get a quote.");
            setTimeout(function() {
