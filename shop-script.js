...
if (searchInput) {
    ...
    searchInput.addEventListener("input", function () {
        ...
        if (active)
            category = active.textContent.toLowerCase();

        if (category === "wraps") category = "wrap";
        if (category === "tapes") category = "tape";
        if (category === "boxes") category = "boxes";
        if (category === "ppe") category = "ppe";
        if (category === "void fill") category = "void";
